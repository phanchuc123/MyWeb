        ...
        <header>
            ...
            <div className="header_item">
                <nav className="nav__pc">
                    ...
                    <Link className = "item item2" to = "/shop">Shop</Link>
                    <Link className = "item item3" to = "/about">About</Link>
                    <Link className = "item item4" to = "/contact">Contact</Link>
                </nav>
            </div>
            ...
            <nav className="nav__mobile">
                ...
                <Link className = "item item3" to = "/about">About</Link>
                <Link className = "item item4" to = "/contact">Contact</Link>
                <Link className = "item item5">Cart</Link>
